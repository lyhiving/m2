	...
	function get_options () {
		...
		if (!is_array($options)) {
			...
			$options['text_links'] = array(
				array('美国 BlueHost 主机', 'red', 'http://www.bluehost.com/track/mangguo'),
				array('美国 HostMonster 主机', 'orange', 'http://www.hostmonster.com/track/mangguo'),
				array('美国 JustHost 主机', 'green', 'http://stats.justhost.com/track?c38717e2731a3cc908b64aadd428b8aba'),
				array('美国 HawkHost 老鹰主机', 'red', 'https://my.hawkhost.com/aff.php?aff=3100'),
				array('美国 HostGator 鳄鱼主机', 'orange', 'http://secure.hostgator.com/cgi-bin/affiliates/clickthru.cgi?id=mangguo')
			);
